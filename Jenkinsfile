...
node {
   ...
   // }
    stage('build'){
        ...
        hygieiaDeployPublishStep applicationName: 'ansible-maven-sample', artifactDirectory: 'target', artifactGroup: 'com.cfets.devops', artifactName: '*.jar', artifactVersion: '0.0.7', buildStatus: 'Success', environmentName: 'dev'
    }
    }catch(e){
